We are looking to add multiple feeds from Salsify which is a product management syndication tool. Using their API we want to bring in products that meet certain criteria. 
